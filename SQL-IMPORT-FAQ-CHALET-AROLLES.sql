...
-- ============================================
--
-- IMPORTANT : Remplacez 'chalet_arolles' par le property_id réel du client
--
-- Étape 1 : Supprimer l'ancienne FAQ du client
-- Étape 2 : Insérer les 12 nouveaux chunks optimisés
-- ============================================

-- ÉTAPE 1 : SUPPRESSION DE L'ANCIENNE FAQ
-- Remplacez 'chalet_arolles' par le vrai property_id

DELETE FROM rag_test_for_charles_locabot
WHERE property_id = 'chalet_arolles';

-- ÉTAPE 2 : INSERTION DES 12 CHUNKS OPTIMISÉS
